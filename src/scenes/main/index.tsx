...
import PaperInfoCard from '../../components/paper'
  ...
  render() {
    ...
    return (
      <div>
        ...
        <section className="bg-gray section-padding section-margin">
          <div className="container">
            <div className="section-intro text-center">
              <h2>Что такое Взлёт?</h2>
            </div>
            <div className="col-lg-12 col-md-6 align-self-center about-content">
              <h5>Взлёт - это сайт, предназначенный для единственной цели: помочь Вам найти достойную работу.</h5>
              <p>
                Работа - одна из главных составляющих жизни человека, это вопрос самоактуализации, стремлении к наиболее
                полному выявлению и развитию личностных возможностей, что является неотъемлемым условием счастья. Мы
                верим, что для каждого человека есть подходящая работа, которая дополнит его жизнь смыслом и радостью
